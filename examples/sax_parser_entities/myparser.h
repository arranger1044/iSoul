...
protected:
  ...
  virtual void on_entity_declaration(const std::string& name, xmlpp::XmlEntityType type, const std::string& publicId, const std::string& systemId, const std::string& content);
};
